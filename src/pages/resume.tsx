    ...
    <Container>
      <Row>
        <Col md="6">
          ...
          <dl>
            To learn interesting and new technologies, and to challenge and push
            my skills and abilities related to computer science.
          </dl>
        </Col>
        <Col md="6">
          <h2>
          ...
          <dl>
            ...
            <dd>
              ...
              Interactive Media and Game Development, May 2015
            </dd>
        ...
        <Col md="6">
          ...
          <dl>
            ...
            <dd>
              ...
              Automation/DevOps working on development and production
            ...
            <dd>
              Worked on a large code base with a team of interns and co-ops
              using pair programming. Projects included a C# XML parsing SDK,
              working with Spring Framework, working with Groovy/Grails, and
              working with Gradle.
            </dd>
            <dt>
              Litle & Co, Lowell, MA, May 2013 – August 2013, May 2014 – August
              2014
            ...
            <dd>
              Provided remote troubleshooting and support through phone, e-mail
              and in-person for WPI faculty, staff, and students.
            </dd>
          </dl>
        </Col>
