          ...
          <ul>
            <li>
              <ExternalLink
                ...
                ariaLabel="JHipster (opens in a new tab)"
              >
                JHipster
              </ExternalLink>
            </li>
          ...
          <ul>
            <li>
              <ExternalLink
                ...
                ariaLabel="Hystrix (opens in a new tab)"
              >
                Hystrix
              </ExternalLink>
            </li>
            <li>
              <ExternalLink
                ...
                ariaLabel="Spring Cloud (opens in a new tab)"
              >
                Spring Cloud
              </ExternalLink>
            </li>
          ...
          <ul>
            <li>
              <ExternalLink
                ...
                ariaLabel="ANTLR4 - NEJUG Edition (opens in a new tab)"
              >
                ANTLR4 - NEJUG Edition
              </ExternalLink>{" "}
              <ExternalLink
                href="https://vimeo.com/199478127"
                ariaLabel="ANTLR4 - NEJUG Edition (Video Recording) (opens in a new tab)"
              >
                (Video Recording)
              </ExternalLink>
            </li>
          ...
          <ul>
            <li>
              <ExternalLink
                ...
                ariaLabel="ANTLR4 (opens in a new tab)"
              >
                ANTLR4
              </ExternalLink>
            </li>
            <li>
              <ExternalLink
                ...
                ariaLabel="Java Classloader (opens in a new tab)"
              >
                Java Classloader
              </ExternalLink>
            </li>
            <li>
              <ExternalLink
                ...
                ariaLabel="Java Persistance API Overview (opens in a new tab)"
              >
            ...
            <li>
              <ExternalLink
                ...
                ariaLabel="Git Overview (opens in a new tab)"
              >
                Git Overview
              </ExternalLink>
            </li>
            <li>
              <ExternalLink
                ...
                ariaLabel="Grails 2.1 Unit Testing (opens in a new tab)"
              >
            ...
            <li>
              <ExternalLink
                ...
                ariaLabel="Grails 2.5 Unit Testing (opens in a new tab)"
              >
            ...
            <li>
              <ExternalLink
                ...
                ariaLabel="Spring Boot Intro (opens in a new tab)"
              >
                Spring Boot Intro
              </ExternalLink>
            </li>
