...
## 2026-05-12 - Static Site Micro-Optimizations
**Learning:** In a statically generated Astro site without client-side re-renders, micro-optimizations (like extracting inline variables or caching DateTimeFormat) have no measurable performance impact.
**Action:** Do not attempt micro-optimizations on static Astro sites; if no measurable bottleneck exists, stop and do not create a PR.
